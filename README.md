...
|senderTc|string|Zorunlu Değil|12345678998|Gönderen Müşteriye ait TC bilgisini belirtir. Zorunlu değildir. Format kontrolü yapılmaktadır. Doğru değer iletilmesi gerekmektedir.|
|receiverTC|string|Zorunlu Değil|12345678998|Var ise alıcı Müşteriye ait TC bilgisini belirtir. Zorunlu değildir. Format kontrolü yapılmaktadır. Doğru değer iletilmesi gerekmektedir.|
